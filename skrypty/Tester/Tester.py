import argparse
from Exploitation import http_pollution, xss_get, xss_post, sqlinjection, command_inj, xmleei
...
def main():
    ...
    parser.add_argument('--parameter', nargs='*', type=str, help='Podaj parametry GET po spacjach w ""')
    ...
    parser.add_argument('--comminj', type=str, nargs='?', const="AND",  help='Command Injection: currently supporte: "AND", "DoubleAND", "OR"')
    parser.add_argument('--xmleei', action='store_true', help='XML External Entity Injection')
