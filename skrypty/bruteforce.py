...
url = 'http://128.198.49.198:8102/mutillidae/index.php?page=login.php'
headers = {
...
with open(passlist, 'r') as file:
    for line in file:
        ...
        print(response.text)
        if '<td id="id-authentication-failed-td" colspan="2" class="error-message">Password incorrect</td>' in response.text:
